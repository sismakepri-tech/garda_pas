            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(Auth::user()->role ==='kanwil')
                        <x-nav-link :href="route('kanwil.dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                       <x-nav-link :href="route('kanwil.odor')">
                        {{ __('ODOR') }}
                        </x-nav-link>
                    @elseif (Auth::user()->role ==='upt')
                        <x-nav-link :href="route('upt.dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                       <x-nav-link :href="route('upt.odor')">
                        {{ __('ODOR') }}
                        </x-nav-link>
                    @elseif (Auth::user()->role ==='uke')
                        <x-nav-link :href="route('uke.dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                       <x-nav-link :href="route('uke.odor')">
                        {{ __('ODOR') }}
                        </x-nav-link>
                         <x-nav-link :href="route('uke.users')">
                        {{ __('USER') }}
                        </x-nav-link>
