        ...
        <div class="max-w-4xl relative p-4 bg-white rounded-lg border dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Kegiatan</h3>                
            </div>
            <!-- Modal body -->
            ...
            @endif
                ...
                <div class="mb-4">
                    ...
                    <select id="jenis" name="jenis" class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        <option selected value="{{$odor->jenis}}">{{$odor->jenis}}</option>  <!-- Placeholder option, disabled to prevent selection -->
                ...
                <div class="mb-4">
                    ...
                    <select id="stakeholder" name="stakeholder" class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        <option selected value="{{$odor->stakeholder}}">{{$odor->stakeholder}}</option>  <!-- Placeholder option, disabled to prevent selection -->
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="room" id="room" value="{{ $odor->room }}" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="nama ruang kegiatan" required>
                </div>  
                 <div class="mb-4">
                    <label for="HP" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Temuan HP</label>
                    <input type="number" name="HP" id="HP" value="{{ $odor->HP }}" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Temuan HANDPHONE" required>
                </div>
                <div class="mb-4">
                    <label for="SAJAM" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Temuan Senjata Tajam</label>
                    <input type="number" name="SAJAM" id="SAJAM" value="{{ $odor->SAJAM }}" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Temuan Senjata Tajam" required>
                </div> 
                <div class="mb-4">
                    ...
                    <input type="number" name="BARANGELEKTRONIK" value="{{ $odor->BARANGELEKTRONIK }}" id="BARANGELEKTRONIK" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Temuan Barang Elektronik" required>
                </div>
                <div class="mb-4">
                    <label for="NARKOBA" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Temuan Narkoba</label>
                    <input type="number" name="NARKOBA" id="NARKOBA" value="{{ $odor->NARKOBA }}" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Temuan Narkoba" required>
                </div> 
                         ...
                         border-gray-300 focus:ring-primary-500 focus:border-primary-500
                          dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                           dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Tulis BA Disini">{{$odor->BA}}</textarea>
                    </div>
                <div class="mb-4">
                    <label for="dok" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dokumentasi</label>
                    <input type="text" name="dok" id="dok" value="{{ $odor->dokumentasi }}" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                </div>  
